            ...
            <div class="row">
                <div class="col-xs-12">
                    <h2 class="page-header">
                        <i class="fa fa-globe"></i> Laporan Pengeluaran
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="custom-td-jumlah">
                                    <span>Rp</span>
                                    <span class="jumlah-pengeluaran" id="jumlah-pengeluaran-{{ $loop->iteration }}">{{ $data->jumlah }}</span>
                                </td>
                            </tr>
                            @endforeach
                            </tr>
                                ...
                                <td class="custom-td-jumlah">
                                    <span>Rp</span>
                                    <span id="total-pengeluaran">{{ $total }}</span>
                                </td>
                            </tr>
                        </tbody>
                    </table>
