        ...
        <div class="box-body">
            <div class="row">
                <div class="col-sm-12 table-responsive">
                    <table id="tableSumberDana" class="table table-bordered table-striped" style="width: 100%;">
                        <thead>
                            <tr>
...
<script>
    ...
    $(document).ready(function() {
        $('#tableSumberDana').DataTable({
            processing: true,
            serverSide: true, //aktifkan server-side
            responsive: true,
            ajax: {
                url: "{{ route('sumber_dana.index') }}",
                type: 'GET'
            },
            columns: [{
                    data: 'id',
        ...
        $("#form-tambah-edit").validate({
            submitHandler: function(form) {
                ...
                $.ajax({
                    ...
                    url: "{{ route('sumber_dana.store') }}", //url simpan data
                    ...
                    success: function(data) { //jika berhasil 
                        ...
                        var table = $('#tableSumberDana').dataTable(); //inialisasi datatable
    ...
    $('body').on('click', '.edit-post', function() {
        ...
        $.get('sumber_dana/' + data_id + '/edit', function(data) {
            $('#modal-judul').html("Edit Data Sumber Dana");
    ...
    $('#tombol-hapus').click(function() {
        $.ajax({
            ...
            url: "sumber_dana/" + dataId, //eksekusi ajax ke url ini
            type: 'delete',
            beforeSend: function() {
            ...
            success: function(data) { //jika sukses
                setTimeout(function() {
                    ...
                    var table = $('#tableSumberDana').dataTable();
                    table.fnDraw(false); //reset datatable
                });
