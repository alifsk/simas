                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            ...
                            <div class="form-group">
                                <label for="tgl_pengeluaran" class="col-sm-12">Tanggal</label>
                                <div class="col-sm-12">
                                    <input type="date" class="form-control" id="tgl_pengeluaran" name="tgl_pengeluaran" value="" required>
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="jumlah_pengeluaran" class="col-sm-12">Jumlah</label>
                                <div class="col-sm-12">
...
<div class="modal modal-danger fade" role="dialog" id="konfirmasi-modal" data-backdrop="false">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p><b>Jika menghapus Pengeluaran maka</b></p>
...
<script>
    ...
    $('#tombol-tambah').click(function() {
        ...
        $('#modal-judul').html("Tambah Data Pengeluaran"); //valuenya tambah pegawai baru
        ...
        $("#form-tambah-edit").validate({
            submitHandler: function(form) {
                ...
                $.ajax({
                    ...
                    url: "{{ route('pengeluaran.store') }}", //url simpan data
                    ...
                    success: function(data) { //jika berhasil 
                        ...
                        var table = $('#tablePengeluaran').dataTable(); //inialisasi datatable
    ...
    $('body').on('click', '.edit-post', function() {
        ...
        $.get('pengeluaran/' + data_id + '/edit', function(data) {
            $('#modal-judul').html("Edit Data Pengeluaran");
            ...
            $('#jumlah_pengeluaran').val(data.jumlah_pengeluaran);
    ...
    $('#tombol-hapus').click(function() {
        $.ajax({
            ...
            url: "pengeluaran/" + dataId, //eksekusi ajax ke url ini
            type: 'delete',
            beforeSend: function() {
