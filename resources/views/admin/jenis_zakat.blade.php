        ...
        <div class="box-body">
            <div class="row">
                <div class="col-sm-12 table-responsive">
                    <table id="tableJenisZakat" class="table table-bordered table-striped" style="width: 100%;">
                        <thead>
                            <tr>
...
<script>
    ...
    $(document).ready(function() {
        $('#tableJenisZakat').DataTable({
            processing: true,
            serverSide: true, //aktifkan server-side
            responsive: true,
            ajax: {
                url: "{{ route('jenis_zakat.index') }}",
                type: 'GET'
            },
            columns: [{
                    data: 'id',
        ...
        $("#form-tambah-edit").validate({
            submitHandler: function(form) {
                ...
                $.ajax({
                    ...
                    url: "{{ route('jenis_zakat.store') }}", //url simpan data
                    ...
                    success: function(data) { //jika berhasil 
                        ...
                        var table = $('#tableJenisZakat').dataTable(); //inialisasi datatable
    ...
    $('body').on('click', '.edit-post', function() {
        ...
        $.get('jenis_zakat/' + data_id + '/edit', function(data) {
            $('#modal-judul').html("Edit Data Jenis Zakat");
    ...
    $(document).on('click', '.delete', function() {
        ...
        $.ajax({
            url: "jenis_zakat/" + dataId, //eksekusi ajax ke url ini
            type: 'delete',
            beforeSend: function() {
            ...
            success: function(data) { //jika sukses
                setTimeout(function() {
                    ...
                    var table = $('#tableJenisZakat').dataTable();
                    table.fnDraw(false); //reset datatable
                });
                swal({
                    title: "Good job!",
    ...
    //             setTimeout(function() {
    //                 $('#konfirmasi-modal').modal('hide'); //sembunyikan konfirmasi modal
    //                 var oTable = $('#tableJenisZakat').dataTable();
