        ...
        <div class="box-body">
            <div class="row">
                <div class="col-sm-12 table-responsive">
                    <table id="tableJenisKegiatan" class="table table-bordered table-striped" style="width: 100%;">
                        <thead>
                            <tr>
...
<script>
    ...
    $(document).ready(function() {
        $('#tableJenisKegiatan').DataTable({
            processing: true,
            serverSide: true, //aktifkan server-side
            responsive: true,
            ajax: {
                url: "{{ route('jenis_kegiatan.index') }}",
                type: 'GET'
            },
            columns: [{
                    data: 'id',
        ...
        $("#form-tambah-edit").validate({
            submitHandler: function(form) {
                ...
                $.ajax({
                    ...
                    url: "{{ route('jenis_kegiatan.store') }}", //url simpan data
                    ...
                    success: function(data) { //jika berhasil 
                        ...
                        var table = $('#tableJenisKegiatan').dataTable(); //inialisasi datatable
    ...
    $('body').on('click', '.edit-post', function() {
        ...
        $.get('jenis_kegiatan/' + data_id + '/edit', function(data) {
            $('#modal-judul').html("Edit Data Jenis Kegiatan");
    ...
    $('#tombol-hapus').click(function() {
        $.ajax({
            ...
            url: "jenis_kegiatan/" + dataId, //eksekusi ajax ke url ini
            type: 'delete',
            beforeSend: function() {
            ...
            success: function(data) { //jika sukses
                setTimeout(function() {
                    ...
                    var table = $('#tableJenisKegiatan').dataTable();
                    table.fnDraw(false); //reset datatable
                });
